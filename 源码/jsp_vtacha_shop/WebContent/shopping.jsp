...
<div id="position" class="wrap">
	您现在的位置：<a href="index.html">维他茶饮-网上维他茶店</a> &gt; 购物车
</div>
<div class="wrap">
	<div id="shopping">
				...
				<c:forEach var="rs" items="${requestScope.shoplist}">
					...
					<tr id="product_id_1">
						...
						<td class="price" id="price_id_1">
							<span id="priceText" name="priceText" >${rs.es_ep_price}</span><!-- 维他茶单价 --><input type="hidden" name="sPPrice" value="${rs.es_ep_price}" />
						...
						<td class="number">
							<dl>
								...
								<!-- 维他茶id --><input type="hidden" name="spID" value="${rs.es_ep_id}" />
	...
	<script type="text/javascript">
		document.write("Cookie中记录的购物车维他茶ID："+ getCookie("product") + "，可以在动态页面中进行读取");
	</script>
</div>
<div id="footer">
	Copyright &copy;  维他茶饮-网上维他茶店 All Rights Reserved. 
</div>
</body>
</html>
<script>
