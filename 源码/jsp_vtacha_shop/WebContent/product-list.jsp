...
<body>
	...
	<div id="position" class="wrap">
		您现在的位置：<a href="indexSelect">维他茶饮-网上维他茶店</a> &gt; <a
			href="selectProductList">维他茶分类</a> &gt; ${title }
	</div>
	<div id="main" class="wrap">
		<div class="lefter">
			<div class="box">
				...
				<dl>
					<dt>
						<a href="selectProductList">全部维他茶</a>
					</dt>
					<c:forEach var="f" items="${flist}">
						<dt>
		...
		<div class="main">
			<div class="product-list">
				...
				<div class="clear"></div>
				<div class="pager">
					<c:if test="${ cid != null && fid !=null}">
					<ul class="clearfix">
						<li>当前:${cpage}/${tpage }页</li>
						<li><a href="selectProductList?cp=1">首页</a></li>
						<li><a
							href="selectProductList?cp=${cpage-1<=0 ? 1 : cpage-1 }&cid=${cid}&fid=${fid}">上一页</a></li>
						<li><a
							href="selectProductList?cp=${cpage+1>=tpage ? tpage : cpage+1 }&cid=${cid}&fid=${fid}">下一页</a></li>
						<li><a href="selectProductList?cp=${tpage }&cid=${cid}&fid=${fid}">尾页</a></li>
						<li><select onchange="jump(this.value)">
								<c:forEach var="i" begin="1" end="${tpage}">
									<option ${i==cpage ? "selected" : "" } value="${i}">${i }页</option>
								</c:forEach>
					...
					<ul class="clearfix">
						...
						<li><a href="selectProductList?cp=1">首页</a></li>
						<li><a
							href="selectProductList?cp=${cpage-1<=0 ? 1 : cpage-1 }&cid=${cid}">上一页</a></li>
						<li><a
							href="selectProductList?cp=${cpage+1>=tpage ? tpage : cpage+1 }&cid=${cid}">下一页</a></li>
						<li><a href="selectProductList?cp=${tpage }&cid=${cid}">尾页</a></li>
						<li><select onchange="jump(this.value)">
								<c:forEach var="i" begin="1" end="${tpage}">
									<option ${i==cpage ? "selected" : "" } value="${i}">${i }页</option>
								</c:forEach>
					...
					<ul class="clearfix">
						...
						<li><a href="selectProductList?cp=1">首页</a></li>
						<li><a
							href="selectProductList?cp=${cpage-1<=0 ? 1 : cpage-1 }&fid=${fid}">上一页</a></li>
						<li><a
							href="selectProductList?cp=${cpage+1>=tpage ? tpage : cpage+1 }&fid=${fid}">下一页</a></li>
						<li><a href="selectProductList?cp=${tpage }&fid=${fid}">尾页</a></li>
						<li><select onchange="jump(this.value)">
								<c:forEach var="i" begin="1" end="${tpage}">
									<option ${i==cpage ? "selected" : "" } value="${i}">${i }页</option>
								</c:forEach>
	...
	<div id="footer">Copyright &copy;  维他茶饮-网上维他茶店 All Rights
		Reserved. </div>
</body>
</html>
