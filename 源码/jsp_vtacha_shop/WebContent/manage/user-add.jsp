...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li><a href="productSelect">维他茶</a></li>
...
<div id="position" class="wrap">
	您现在的位置：<a href="index.jsp">维他茶饮-网上维他茶店</a> &gt; 管理后台
</div>
	...
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
				...
				<dd><em><a href="productAdd">新增</a></em><a href="productSelect">维他茶管理</a></dd>
				<dt>订单管理</dt>
				...
				<table class="form">
					...
					<tr>
							...
							<td><select name="courty">
									<option value="中国大陆" <c:if test="${commom_user.EU_COURTY eq '中国大陆'}">selected</c:if>>中国大陆</option>
									<option value="港澳台"<c:if test="${commom_user.EU_COURTY eq '港澳台'}">selected</c:if>>港澳台</option>
									<option value="海外"<c:if test="${commom_user.EU_COURTY eq '海外'}">selected</c:if>>海外</option>
							</select></td>
						</tr>
					<tr>
