				...
				<form id="regForm" action="register"
					...
					<table>
						...
						<tr>
							...
							<td><input type="text" class="text"  onblur="Checknum(this);"  name="email" id="email" value="" /></td>
							<span
								id="msg"></span>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><select name="courty">
									<option value="volvo">中国大陆</option>
									<option value="saab">港澳台</option>
									<option value="opel">海外</option>
							</select></td>
						</tr>
						<tr>
